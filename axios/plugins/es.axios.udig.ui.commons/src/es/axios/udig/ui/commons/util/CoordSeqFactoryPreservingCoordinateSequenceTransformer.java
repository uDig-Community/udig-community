 ...
 * <p>
 * This transformer extends GeoTools {@link DefaultCoordinateSequenceTransformer} 
 * The base class uses a user provided CoordinateSequenceFactory. The rational is that 
 * DefaultCoordinateSequenceTransformer uses JTS {@code DefaultCoordinateSequenceFactory} 
 * then we need to preserve the one used in the GeometryFactory being used by uDig. 
 * (aka, {@link LiteCoordinateSequenceFactory}.
 * </p>
 * <p>
 * Note: this issue was solved in GeoTools 2.4.
 * TODO: This class will be deprecated when uDig will be update with GeoTools 2.4
 * </p>
 * 
 * @since 1.1.0
 * 
