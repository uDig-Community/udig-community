...
public interface PreferenceConstants {
	...
	String SPATIAL_JOIN_RESULT_SELECTION	= "SPATIAL_JOIN_RESULT_SELECTION"; //$NON-NLS-1$
	
	String SHOW_DEMO = "Show_demo"; //$NON-NLS-1$
	String POLYGONTOLINE_EXPLODE = "Explode"; //$NON-NLS-1$
}
