...
public class TrimTool extends AbstractEditTool {
    ...
    protected void initAcceptBehaviours( List<Behaviour> acceptBehaviours ) {
        DefaultEdittingToolsCommandFactory commandFactory;
        commandFactory = new DefaultEdittingToolsCommandFactory();
        acceptBehaviours.add(new TrimGeometryBehaviour(commandFactory));
    }
