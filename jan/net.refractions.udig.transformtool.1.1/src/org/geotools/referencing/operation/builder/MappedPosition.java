 ...
 * @version $Id: MappedPosition.java 25262 2007-04-23 21:11:16Z desruisseaux $
 * @author Jan Jezek
...
public class MappedPosition implements Serializable {
    ...
    /**
     * 
     * Returns diferences in specified dimension  
     */   
   /* public double getDelta(int dim){
    	return source.getOrdinate(dim)-target.getOrdinate(dim);
    }*/
    /**
