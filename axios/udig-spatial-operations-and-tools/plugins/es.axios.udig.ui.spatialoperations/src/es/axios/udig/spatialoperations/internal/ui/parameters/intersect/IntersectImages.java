...
/**
 * A class that stores the different intersect images and show the correspondent
 * image.
 * 
 ...
 */
final class IntersectImages extends AbstractImagesOperation {
	...
	public Image getImage(Boolean chkSource, Boolean chkResult) {
		...
		case Source:
			...
			this.currentImage = getImage(INTERSECT_SOURCE);
			break;
		case Result:

			this.currentImage = getImage(INTERSECT_RESULT);
			break;
		case Final:

			this.currentImage = getImage(INTERSECT_FINAL);
			break;
		default:
	...
	protected void createImageRegistry() {
		...
		addImageToRegistry(INTERSECT_SOURCE, IntersectImages.class);
		addImageToRegistry(INTERSECT_RESULT, IntersectImages.class);
		addImageToRegistry(INTERSECT_FINAL, IntersectImages.class);
	}
