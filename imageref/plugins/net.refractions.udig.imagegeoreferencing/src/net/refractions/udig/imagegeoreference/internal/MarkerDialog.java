    ...
    */ 
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        if (mapGraphic == null || mapGraphic.getImages() == null ||
        		mapGraphic.getImages().get(map) == null ||
    ...
    private void createMainDialogContents(Composite container) {
        createControlsSingleLabel(container, MessageFormat.format(Messages.MarkerDialog_desc, markerCount, markerCount, markerCount));      
