 ...
 * @since 1.1.0
 */
public class ClipInNewLayerParameters extends AbstractClipParameters
        implements
            IClipInNewLayerParameters {
     ...
     */
    public ClipInNewLayerParameters( final ILayer clippingLayer, final ILayer layerToClip,
