package es.axios.udig.georeferencing.internal.i18n;

import org.eclipse.osgi.util.NLS;

public class Messages extends NLS {
	private static final String	BUNDLE_NAME	= "es.axios.udig.georeferencing.internal.i18n.messages"; //$NON-NLS-1$
