...
/**
 * Mock implementation of {@link EditingToolsCommandFactory} to support unit tests.
 * 
 * @author Gabriel Roldan (www.axios.es)
 * @author Mauricio Pazos (www.axios.es)
 * @since 1.1.0
 */
public class MockEdittingToolsCommandFactory implements EditingToolsCommandFactory {
    ...
    /**
     * Base class for mock commands. Extend as needed to provide specific test behaviour.
     */
