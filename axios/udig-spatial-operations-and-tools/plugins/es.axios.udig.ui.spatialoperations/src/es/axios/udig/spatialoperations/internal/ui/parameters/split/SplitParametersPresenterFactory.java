...
/**
 * 
 * Makes the widgets required by Split Operation
 * <p>
 * 
 * </p>
 * 
 ...
 * @since 1.2.0
 */
public final class SplitParametersPresenterFactory implements ISOParametersPresenterFactory {
	...
	public ISOAggregatedPresenter createDataComposite(ScrolledComposite dataParent, int style) {
		...
		ISOAggregatedPresenter p = new SplitComposite(dataParent, style);
		return p;
	}
	...
	public IImageOperation createDemoImages() {
		...
		IImageOperation img = new SplitImages();
		return img;
	}
