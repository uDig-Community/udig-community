 ...
 * @since 1.2.0
 */
public final class FillParametersPresenterFactory implements ISOParametersPresenterFactory {
	...
	public ISOAggregatedPresenter createDataComposite(ScrolledComposite dataParent, int style) {
		...
		ISOAggregatedPresenter p = new FillComposite(dataParent, style);
		return p;
	}
	...
	public IImageOperation createDemoImages() {
		IImageOperation img = new FillImages();
		return img;
	}
