 ...
 * <p>
 * This is a wrapper over UndoableComposite which is responsible 
 * to construct the command list required to delete the source 
 * features and create the new merged feature.
 * </p>
...
final class MergeFeaturesCommand implements UndoableMapCommand{
     ...
     * @param mergedFeature
     */
    public MergeFeaturesCommand( final ILayer layer, final  FeatureCollection<SimpleFeatureType, SimpleFeature> sourceFeatures, final SimpleFeature mergedFeature ) {
