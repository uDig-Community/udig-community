...
/**
 * This factory make the widgets required by the intersect operation
 * <p>
 * 
 * </p>
 * 
 ...
 * @since 1.2.0
 */
public final class IntersectParametersPresenterFactory implements ISOParametersPresenterFactory {
	...
	public ISOAggregatedPresenter createDataComposite(ScrolledComposite dataParent, int style) {
		ISOAggregatedPresenter p = new IntersectComposite(dataParent, style);
		return p;
	}
	...
	public IImageOperation createDemoImages() {
		...
		IImageOperation img = new IntersectImages();
		return img;
	}
