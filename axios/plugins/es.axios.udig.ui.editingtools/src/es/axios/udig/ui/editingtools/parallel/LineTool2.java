...
/**
 * Temporal replacement for {@link LineTool} while we define the framework for adding dynamic
 * behaviour modifiers
 * <p>
 * TODO: move changes to {@link LineTool} and eliminate this class once the approach is accepted
 * </p>
 * 
...
public class LineTool2 extends LineTool {
    ...
    protected void initEventBehaviours( EditToolConfigurationHelper helper ) {
        ...
        helper
              .add(new CursorControlBehaviour(
                                              ...
                                              new ConditionalProvider(
                                                                      handler,
                                                                      Messages.LineTool_select_or_create_feature,
                                                                      Messages.LineTool_add_vertex_or_finish),
                                              new CursorControlBehaviour.SystemCursorProvider(
                                                                                              SWT.CURSOR_SIZEALL),
                                              new ConditionalProvider(
                                                                      handler,
                                                                      Messages.LineTool_move_vertex,
                                                                      null),
                                              new CursorControlBehaviour.SystemCursorProvider(
                                                                                              SWT.CURSOR_CROSS),
                                              new ConditionalProvider(handler,
                                                                      Messages.LineTool_add_vertex,
                                                                      null)));
        ...
        SelectFeatureBehaviour selectGeometryBehaviour =
            new SelectFeatureBehaviour(new Class[]{LineString.class, LinearRing.class, MultiLineString.class}, Intersects.class);        
