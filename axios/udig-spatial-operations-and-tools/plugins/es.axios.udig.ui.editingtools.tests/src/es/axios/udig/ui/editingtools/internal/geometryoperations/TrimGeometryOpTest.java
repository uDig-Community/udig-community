...
public class TrimGeometryOpTest extends TestCase {
	...
	/**
	 * Line used as cutting edge digitized clockwise.
	 * <code>LINESTRING(1 0, 1 10)</code>
	 */
	private LineString						clockwiseTrimLine;
	/**
	 * Line used as cutting edge digitized counter clockwise.
	 * <code>LINESTRING(1 10, 1 0)</code>
	 */
	...
	public void testValidatePreconditionIntersection() {
		Coordinate[] coordinates = { new Coordinate(2, 1), new Coordinate(-1, 1), new Coordinate(2, 2) };
	...
	/**
	 * {@link TrimGeometryStrategy} cuts the input geometries at the right of
	 * the trimming line, and returns the remaining at the left.
	 * 
	...
	/**
	 * If the trimming line touches the input line but does not crosses it,
	 * trimOp has to return an empty geom or the input geom depending on the
	 * direction
	 * 
	 * @throws ParseException
	 */
