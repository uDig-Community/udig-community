...
/**
 * Splits one or more SimpleFeature using a {@link SplitGeometryBehaviour} to accomplish the task
 * once the user finished drawing the splitting line.
 * <p>
...
public class SplitTool extends AbstractEditTool {
    ...
    /**
     * Initialises the list of Behaviours to run when the current edit has been accepted. Acceptance
    ...
    protected void initAcceptBehaviours( List<Behaviour> acceptBehaviours ) {
        ...
        acceptBehaviours.add(new SplitGeometryBehaviour(commandFactory));
        acceptBehaviours.add(new RefreshLayersBehaviour());
    }

    /**
     * Initialises the behaviours that are ran when a cancel signal is received (the ESC key).
     * 
    ...
    /**
     * Initialises the Event Behaviours that are run when an event occurs. Since this can be complex
    ...
    /**
     * Initialises the list of {@link EnablementBehaviour}s that are ran to determine if the tool
