...
//    private static FeatureType  fType;
...
//        features[0] = feature(fType, "name1", "LINESTRING(0 0, 10 10)", 1);
//        features[1] = feature(fType, "name2", "LINESTRING(10 10, 10 20)", 1);
//        features[2] = feature(fType, "name3", "LINESTRING(10 20, 20 20)", 1);
//
//        mergedGeometry = new WKTReader().read("LINESTRING(0 0, 10 10, 10 20, 20 20)");
//    }
//
//    private static Feature feature( FeatureType ft, String name, String geom, int intAtt ) throws Exception {
...
//        }
//
//        FeatureType anotherSchema = DataUtilities.createSubType(fType, new String[]{ATTNAME_NAME,
//                ATTNAME_INTATT});
//        Feature[] mixedFeatures = new Feature[4];
//        mixedFeatures[0] = features[0];
//        mixedFeatures[1] = features[1];
//        mixedFeatures[2] = features[2];
//        Feature nonGeometryFeature = anotherSchema
//                                                  .create(new Object[]{"a name", new Integer(1000)});
...
//        }
//
//        Feature[] nonGeomCollection = {nonGeometryFeature};
//        try {
...
//        List<AttributeType> attributes = Arrays.asList(fType.getAttributeTypes());
//        FailOnDemandType failingType;
//        GeometryAttributeType defaultGeom = (GeometryAttributeType) fType
//                                                                         .getAttributeType(ATTNAME_GEOM);
//        failingType = new FailOnDemandType(typeName, "", attributes, Collections.EMPTY_LIST,
//                                           defaultGeom);
//
//        Feature f = failingType.create(features[0].getAttributes((Object[]) null));
//        Feature[] collection = {f};
//        builder = new MergeFeatureBuilder(collection, null);
//
//        // now force our feature type to fail on create
//        failingType.failOnCreate = true;
//        try {
//            builder.buildMergedFeature();
//            fail("cleared a non null attribute shouldn't allow to build the merge feature");
...
//
//        Geometry assignedGeometry = features[0].getDefaultGeometry();
//
//        Feature merged = builder.buildMergedFeature();
...
//        final int geomAttIndex = fType.find(ATTNAME_GEOM);
...
//        // de value of a feature where the geom is also null
